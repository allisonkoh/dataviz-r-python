...
```{r toying around with data to replace current example, include = FALSE}
...
# rpdr 
rpdr.df <- readxl::read_xlsx("/Users/allisonwun-huikoh/Documents/GitHub/dataviz-r-python/data/RuPaul-Predict-A-Looza — Data Tables.xlsx",sheet = 3)
View(rpdr.df)

rpdr.df1 <- readxl::read_xlsx("data/RuPaul-Predict-A-Looza — Data Tables.xlsx", sheet = 5)
View(rpdr.df1)

# bachelor 
names(fivethirtyeight::bachelorette)
```
